    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-50">
        <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-6">
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-[#4C2F5E]">My Topics</h1>
              <p className="text-sm text-[#6E7D7D]">Discussions you've started and are following</p>
            </div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-6">
        <div className="space-y-3">
          {topics.map((topic) => (
            <div key={topic.id} className="bg-white rounded-lg p-4 md:p-5 border border-gray-50 shadow-sm hover:shadow-md transition group">
              ...
              <div className="flex items-center justify-between text-xs text-gray-500 flex-wrap gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs md:text-sm text-[#6E7D7D] font-medium">{topic.author}</span>
                </div>
                ...
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <span className="hidden sm:inline">{topic.timeAgo}</span>
                </div>
              </div>
            </div>
          ))}
