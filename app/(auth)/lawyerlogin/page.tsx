...
import { Eye, EyeOff, CheckSquare, XCircle, CheckCircle2 } from "lucide-react";
  ...
  const runLoginPipeline = async () => {
    ...
    try {
      const res = await fetch("/api/auth/login", {
        ...
        body: JSON.stringify({ ...formData, loginType: "LAWYER" }),
      });
            ...
            <>
              ...
              >
                  ...
                  {formData.password && pwStrength && (
                    <div className="mt-2">
                      ...
                      <div className="flex justify-between items-center mt-1 text-[11px] font-semibold">
                        <p className={pwStrength.textColor}>
                          {pwStrength.label}
                        </p>
                        <p
                          className={
                ...
                <div className="flex justify-between items-center mb-7">
                  ...
                  <Link
                    href="/forgot-password?portal=lawyer"
              ...
              <p className="text-center text-base text-black mt-4">
                ...
                <Link
                  href="/lawyerregister"
                  className="text-[#9F63C4] font-bold"
                >
                  Sign up
                </Link>
              </p>
