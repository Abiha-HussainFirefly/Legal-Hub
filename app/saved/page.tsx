      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-6 py-6">
          ...
          <div className="flex items-start justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 mb-1">Saved Discussions</h1>
              <p className="text-sm text-gray-600">Legal discussions you've bookmarked for later refrence</p>
            </div>
            <Link
  href="/discussion/1"
  ...
  New Discussion
      ...
      <div className="container mx-auto px-6 py-6">
        <div className="max-w-4xl space-y-4">
          {myTopics.map((saved) => (
            <div key={saved.id} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition">
              {/* Topic Number & Title */}
              <div className="mb-3">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                      <span className="font-medium">{saved.number}</span> {saved.excerpt}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-700">{saved.author.name}</span>
                </div>
